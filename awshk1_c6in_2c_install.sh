...
#  用法：sudo bash awshk_c5n_2c_install.sh
#        sudo bash awshk_c5n_2c_install.sh --uninstall
# =============================================================
set -euo pipefail
...
NYANPASS2_TOKEN="5a4e7912-9faa-4a71-9d42-cd76a0ed39ce"
...
if [[ ! -f "$TARGET_SCRIPT" ]]; then
    ...
    echo "请把 vps3_all_in_one_install.sh 和 awshk_c5n_2c_install.sh 放在同一目录后再执行。"
    exit 1
fi
