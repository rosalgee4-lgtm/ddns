...
#  用法：sudo bash awsjp_c6in_2c_install.sh
#        sudo bash awsjp_c6in_2c_install.sh --uninstall
# =============================================================
set -euo pipefail
...
NYANPASS4_NAME="awsjp4"
NYANPASS4_TOKEN="7ef35a04-1bf7-4dcf-a769-e67be1d907df"
...
configure_bbr() {
    log INFO "配置 BBR + fq（AWS JP c6in.large）..."
