...
#  用法：sudo bash awsmy_c5n_2c_install.sh
#        sudo bash awsmy_c5n_2c_install.sh --uninstall
# =============================================================
set -euo pipefail
...
VPS2_URL="http://69.12.74.54:43304/update"
...
configure_bbr() {
    log INFO "配置 BBR + fq（AWS 马来 c5.large）..."
